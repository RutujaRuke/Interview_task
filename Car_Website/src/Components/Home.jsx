    ...
    return (
        ...
        >
          XUV 700
                ...
                <motion.h1
                    className="text-7xl md:text-8xl font-bold text-center text-blue-600 mb-[]"
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 1 }}
                >
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 rounded-full w-72 h-72 bg-blue-500 opacity-50 shadow-lg"></div> {/* Added shadow */}
                ...
                >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 rounded-full w-72 h-72 bg-gradient-to-b from-sky-500 via-transparent to-transparent opacity-80 shadow-2xl"
                    ></div>
